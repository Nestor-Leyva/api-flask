...
#Se escribe para en una cadena ingresar los valores previamente definidos
#Con esta cadena se crea la conección a la base de datos
DB_URL = f'mysql+pymysql://{db_usuario}:{db_clave}@{db_host}/{db_nombre}'

app.config['SQLACHEMY_DATABASE_URI'] = DB_URL
app.config['SQLACHEMY_TRACK_MODIFICATIONS'] = False

app.config['JWT_SECRET_KEY'] = os.environ.get('JWT_SECRET_KEY')
#Se crea expiración del token
